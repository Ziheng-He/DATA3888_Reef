...
python dash stuff.. (how it works)

### Innovation

about python dash .. etc (whats cool about it)
e.g. keeps the old data points on map?
...
Bryan He: data visualizations, speaking for presentation, dash implementation, merging dataset, Describing implementation of Dash in report, revising report.

Kitty Jo：Logistic regression model fitting, data visualizations, model evaluation, model comparison, speaking for presentation, writing executive summary, evaluations, discussion part of report, revising report.

Harry Xu：Random forest model fitting, data visualizations, evaluating the feature extraction strategy and tuning the final ML model. Write the Executive Summary, Data Collection and Preprocessing, Evaluations, Machine Learning Algorithm part of report, revising report.

Oliver He：Support-vector machine fitting, data visualizations, write the results section and the discussion part of the report, revising report.
...
- https://www.gbrmpa.gov.au/our-work/threats-to-the-reef/climate-change/ocean-currents 
